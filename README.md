...
| GET        | /vemec/cnt_by_estado              | Obtiene la cantidad de VeMec por su determinado estado (esta siendo utilizado o no).                                                                                                                                                           |
...
| GET        | /paciente?page=:pagina&limit=:limite&nombre=:nombre&apellido=:apellido | Obtiene todos los Pacientes que hay guardados en la Base de Datos consumida. Se debe brindar un numero de pagina y un limite de Pacientes para la misma.Tambien se le puede pasar un nombre y/o un apellido  para filtrar por estos.                                                  |
| GET        | /paciente/:id                        | Obtiene un Paciente especifico, basado en el parametro id brindado en la URL.    
| GET        | /paciente/cnt_by_edad                      | Obtiene la cantidad de pacientes en diferentes rangos de edad.                                                                                                                            |
